...
async function searchTweets(token, query) {
    const endpoint = `${TWITTER_API_ENDPOINT}/2/tweets/search/recent?query=${query}&tweet.fields=text,created_at&user.fields=username,profile_image_url&expansions=author_id&max_results=100`

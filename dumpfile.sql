...
ALTER TABLE public.sentiment OWNER TO ben;

--
-- Name: stock; Type: TABLE; Schema: public; Owner: ben
--
...
ALTER TABLE public.stock OWNER TO ben;

--
-- Name: tweet_information; Type: TABLE; Schema: public; Owner: ben
--
...
ALTER TABLE public.tweet_information OWNER TO ben;

--
-- Name: twitter_user; Type: TABLE; Schema: public; Owner: ben
--
...
ALTER TABLE public.twitter_user OWNER TO ben;

--
-- Data for Name: sentiment; Type: TABLE DATA; Schema: public; Owner: ben
--
...
--
-- Data for Name: stock; Type: TABLE DATA; Schema: public; Owner: ben
--
...
--
-- Data for Name: tweet_information; Type: TABLE DATA; Schema: public; Owner: ben
--
...
--
-- Data for Name: twitter_user; Type: TABLE DATA; Schema: public; Owner: ben
--
...
--
-- Name: sentiment sentiment_pkey; Type: CONSTRAINT; Schema: public; Owner: ben
--
...
--
-- Name: stock stock_pkey; Type: CONSTRAINT; Schema: public; Owner: ben
--
...
--
-- Name: tweet_information tweet_information_pkey; Type: CONSTRAINT; Schema: public; Owner: ben
--
...
--
-- Name: twitter_user twitter_user_pkey; Type: CONSTRAINT; Schema: public; Owner: ben
--
...
--
-- Name: sentiment sentiment_se_symbol_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ben
--
...
--
-- Name: sentiment sentiment_se_tweet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ben
--
...
--
-- Name: tweet_information tweet_information_ti_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ben
--
